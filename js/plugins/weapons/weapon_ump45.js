...
plugin.register({
  ...
  shoot(owner) {
    ...
    if (bs && bs.enabled) {
      bs.spawn({ position: pos, direction: dir, speed: 500, damage: this.damage, knockback: this.knockback, knockbackDistance: this.knockbackDistance, count: 1, life: 2.0, size: 0.04, spread: 0.015 });
    }
