PluginRegistry.register({
  ...
  init(game) {
    ...
    PluginRegistry.on('game:pause', 'ui_pause', function() {
      this.show();
    }.bind(this));

    PluginRegistry.on('game:resume', 'ui_pause', function() {
      this.hide();
    }.bind(this));

    PluginRegistry.on('game:start', 'ui_pause', function() {
      this.hide();
    }.bind(this));
  ...
  destroy() {
    ...
    PluginRegistry.off('game:pause', this.id);
    PluginRegistry.off('game:resume', this.id);
