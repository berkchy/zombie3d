...
plugin.register({
  ...
  animations: {
    fire: {
      ...
      loop: false,
      tracks: [
        // Bıçak kolla senkron — sadece hafif ekstra kamçı
        { pivot: '__self__', prop: 'position.x', keys: [0, 0.005, -0.04, -0.06, 0] },
        { pivot: '__self__', prop: 'rotation.z', keys: [0, -0.01, 0.04, 0.06, 0] },
        { pivot: '__self__', prop: 'rotation.y', keys: [0, 0.005, -0.03, -0.04, 0] }
      ]
    }
  }
});
