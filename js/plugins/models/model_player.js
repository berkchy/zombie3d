...
plugin.register({
  ...
  createModel() {
    ...
    // ===== UST BACAKLAR =====
    var upperLegGeo = new THREE.CylinderGeometry(0.08, 0.07, 0.16, 6);
    var upperLegL = new THREE.Mesh(upperLegGeo, pantsMat);
    upperLegL.position.set(0, 0.03, 0);
    ...
    upperLegR.position.set(0, 0.03, 0);
    ...
    kneeLPivot.position.set(0, -0.05, 0);
    legLPivot.add(kneeLPivot);

    var kneeRPivot = new THREE.Object3D();
    kneeRPivot.name = 'kneeR';
    kneeRPivot.position.set(0, -0.05, 0);
    legRPivot.add(kneeRPivot);

    // ===== ALT BACAKLAR =====
    var lowerLegGeo = new THREE.CylinderGeometry(0.07, 0.06, 0.12, 6);
  ...
  animations: {
    ...
    run: {
      ...
      tracks: [
        ...
        { pivot: 'armL', prop: 'rotation.z', keys: [0, 0.06, 0] },
        { pivot: 'armR', prop: 'rotation.z', keys: [0, -0.06, 0] },
        { pivot: 'legL', prop: 'rotation.x', keys: [-0.35, 0.35, -0.35] },
        { pivot: 'legR', prop: 'rotation.x', keys: [0.35, -0.35, 0.35] },
        { pivot: 'kneeL', prop: 'rotation.x', keys: [0.15, 0.4, 0.15] },
        { pivot: 'kneeR', prop: 'rotation.x', keys: [0.4, 0.15, 0.4] },
        { pivot: 'torso', prop: 'rotation.z', keys: [0, 0.03, 0] },
        { pivot: 'torso', prop: 'rotation.x', keys: [0.04, -0.04, 0.04] }
      ]
    },
    die: {
      duration: 1.6,
      ...
      tracks: [
        ...
        { pivot: 'kneeL', prop: 'rotation.x', keys: [0, 0.2] },
        { pivot: 'kneeR', prop: 'rotation.x', keys: [0, 0.2] },
